...
Curriculum → folder-placement strategy, decided once by the obsidian-study skill and reused across sessions. See `~/.claude/skills/obsidian-study/SKILL.md` for how this is used.

| Curriculum | Strategy | Notes |
|---|---|---|
...
| Docker (Interview Prep) | dedicated:Docker | Containerization — no existing folder covers it, same pattern as TypeORM |
